        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#6B6B6B]">
              Log in to continue tailoring your resumes
            </p>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/reset-password" className="text-sm text-[#6B6B6B] hover:text-[#2D2D2D]">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#F7F5F3] text-[#6B6B6B]">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="py-3 px-4 bg-white border border-[#D1D1D1] rounded-lg hover:bg-[#F7F5F3] transition-colors font-medium text-[#2D2D2D] flex items-center justify-center gap-2"
            >
            ...
            <button
              type="button"
              onClick={() => alert('GitHub OAuth will be implemented with backend!')}
              className="py-3 px-4 bg-white border border-[#D1D1D1] rounded-lg hover:bg-[#F7F5F3] transition-colors font-medium text-[#2D2D2D] flex items-center justify-center gap-2"
            >
